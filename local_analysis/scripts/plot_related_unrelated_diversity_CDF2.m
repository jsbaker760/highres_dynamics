function [f,f2]=plot_related_unrelated_diversity_CDF2(M,A1,A2,cutoff_include,cutoff_real)

f=figure
%% C. acnes lineage level
subplot(2,1,1)
BoolInclude = sum(A1,2)>cutoff_include;
[~]=plot_intra_inter1(M(BoolInclude,:),A1(BoolInclude,:),cutoff_real,'C. acnes lineage level');

%% S. epi lineage level
subplot(2,1,2)
BoolInclude = sum(A2,2)>cutoff_include;
[~]=plot_intra_inter1(M(BoolInclude,:),A2(BoolInclude,:),cutoff_real,'S. epi lineage level');
...
subplot(2,1,1)
BoolInclude = sum(A1,2)>cutoff_include;
[~]=plot_intra_inter1_supp(M(BoolInclude,:),A1(BoolInclude,:),cutoff_real,'C. acnes lineage level');
% S. epi lineage level
subplot(2,1,2)
BoolInclude = sum(A2,2)>cutoff_include;
[~]=plot_intra_inter1_supp(M(BoolInclude,:),A2(BoolInclude,:),cutoff_real,'S. epi lineage level');
