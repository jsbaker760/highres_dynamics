...
function BrackenDataAll =  Brackenfiles2Structure
...
SampleNames = string(table2array(readtable('metagenomics_samplenames_tubes.csv','Delimiter',',')));
...
%%
idx_species_files = arrayfun(@(x) max([0 find(x==species_BrackenSampleNames)]), SampleNames);
...
%% Example of how to get info across samples using arrayfun:
% want to get abundance of Cutibacterium acnes
%%
%%
