function LineageData = dmrca_vs_d_pairwise(LineageDMRCAs)
...
LineageDMRCAs.dmrca_vs_pairwise_d=PolarizedTajimaD_subjects(LineageDMRCAs.SubjectTreeSNPs_isolates,10);
LineageData.dmrca_vs_pairwise_d=PolarizedTajimaD_subjects(LineageData.tree_snps,10);
saveas(f,'ManuscriptFigures/PolarizedTajimaDCacnesSepi.svg')
...
ylabel('dMRCA (subject)')
title('C. acnes')
saveas(f,'ManuscriptFigures/NisolatesVersusdMRCA.svg')