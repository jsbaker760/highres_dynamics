...
for a = 1:A
    ...
    if any(consistency)
        ...
        data.(Algorithms{a}).clusters_unique_consistent_adopted=clusters_unique_consistent_adopted;
    end
end
...
marid = midx(b)';
%%
Pacnes_C1.clustcoef = co;
Pacnes_C1.cutoffcoef = marid;
%%
iterations = [numel(uepsilon) numel(uminpts)];
Udb = prod(iterations);
[e,m]=ind2sub(iterations,1:Udb);
...
%%
fprintf(['saving all data...\n'])
save(['Pacnes_C1.mat'],'Pacnes_C1','-v7.3')