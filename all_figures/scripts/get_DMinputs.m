function DMinputs = get_DMinputs(GoodSepiIsolate,GoodCacnesIsolate)
...
load data/SepidermidisATCC12228_UnfilteredMutationVars.mat maNT_unfiltered maf_unfiltered coverage_unfiltered Quals_unfiltered indel_counter_unfiltered
% load data/ParameterSweep/ParameterSweep/Sepi/GoodStaphisolate.mat GoodStaphisolate
%
GoodSepiIsolate = GoodSepiIsolate==1;
%
...
load data/Pacnes_C1_UnfilteredMutationVars.mat maNT_unfiltered maf_unfiltered coverage_unfiltered Quals_unfiltered indel_counter_unfiltered
GoodCacnesIsolate = GoodCacnesIsolate==1;
%
% DETERMINE MAJOR ALLELES FROM COUNTS
fprintf(1,'Determining major alleles from counts...\n')
